...
<table>
 ...
 String s2=session.getAttribute("hospitalname").toString();
...
PreparedStatement ps=con.prepareStatement("SELECT * FROM `medicalrecord`.`prescription` where status='sended' and doctorspecialist='"+s+"' and hospitalname='"+s2+"' ");
